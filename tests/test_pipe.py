"""Single-source expression factories accept their source column as the leading
positional arg, so they compose with Expr.pipe."""
...
def test_positional_src_requires_src_param():
