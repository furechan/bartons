...
Polars plugin providing financial/technical analysis expressions, implemented in Rust via PyO3 + Maturin. Currently exposes EMA, DEMA, TEMA, HMA, ZLEMA, ALMA, SMA, RMA, WMA, MOM, ROC, PPO, RSI, STOCH, WILLR, TRANGE, ATR, NATR, BBANDS, BBP, BBW, BOP, KELTNER, DONCHIAN, MAD, CCI, CLAG, CMF, MFI, OBV, ADL, ADOSC, AROON, AROONOSC, DMI, KER, KAMA, SAR, STREAK, STEP, the LINREG and QUADREG families, and the kernel-free MACD and price transforms (AVGPRICE, MEDPRICE, TYPPRICE, WCLPRICE).
